...
export function FeedItem({ video }: { video: VideoWithUser }) {
  ...
  return (
    <div className="relative h-[calc(100dvh-56px)] w-full snap-start overflow-hidden bg-black">
      {isVid ? (
        <video
          ref={videoRef}
