...
INSERT INTO "new_WithdrawRequest" ("amount", "createdAt", "developerNotifiedAt", "id", "paidAt", "payoutDetails", "rejectedAt", "status", "updatedAt", "userId", "walletId") SELECT "amount", "createdAt", "developerNotifiedAt", "id", "paidAt", "payoutDetails", "rejectedAt", "status", "updatedAt", "userId", "walletId" FROM "WithdrawRequest";
